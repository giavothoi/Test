...
//	printf("ER02 = %X\n", ER02);
	...
	// buoc 5: thuc hien XOR
	unsigned int A1, A2;
	A1 = key1 ^ ER01;
	A2 = key2 ^ ER02;
//	printf("\nKet qua phep XOR: A = E[R0] + K1 \n");
//	printf("A1 = %X\n", A1);
//	printf("A2 = %X\n", A2);
	
	// buoc 6&7: thuc hien pehp the va ghep noi ket qua
	unsigned int B;
	B = SubByte(A1, A2);
...
//		printf("Ket qua phep hoan vi FP = %X\n", FP);
...
//	printf("Ket qua hoan vi P = %X\n", FP);
	...
	// buoc 9 & 10: Tinh R1 = F XOR L0; 10. L1 = R0
//	unsigned int L1, R1;
//	R1 = FP ^ L0;
//	L1 = R0;
//	printf("L1 = %X\n", L1);
